...
//               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_addr_counter_0_0_stub.v
...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(clk, i_reset, i_count_go, i_reset_counter, 
  o_addra_counter)
/* synthesis syn_black_box black_box_pad_pin="clk,i_reset,i_count_go,i_reset_counter,o_addra_counter[31:0]" */;
  input clk;
  input i_reset;
  input i_count_go;
