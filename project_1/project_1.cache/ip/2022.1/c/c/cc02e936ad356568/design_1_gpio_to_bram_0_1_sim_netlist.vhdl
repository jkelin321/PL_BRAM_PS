...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SM is
  port (
    ...
    i_sw1 : in STD_LOGIC;
    i_sw2 : in STD_LOGIC;
    i_addra_counter : in STD_LOGIC_VECTOR ( 12 downto 0 )
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SM is
  ...
  attribute SOFT_HLUTNM of \dina_two_bit[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \dina_two_bit[1]_i_1\ : label is "soft_lutpair7";
begin
  SR(0) <= \^sr\(0);
...
wea_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_gpio_to_bram_v1_0_S_AXI_INTR is
  ...
  attribute SOFT_HLUTNM of \axi_rvalid_i_1__0\ : label is "soft_lutpair10";
...
SM_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_SM
     port map (
      ...
      i_addra_counter(12 downto 0) => i_addra_counter(12 downto 0),
      i_sw1 => i_sw1,
      i_sw2 => i_sw2,
      o_count_go => \^o_count_go\,
